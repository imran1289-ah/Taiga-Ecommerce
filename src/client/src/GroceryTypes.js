...
export default function GroceryTypes() {
  return (
    <Container>
      <Row>
        <Col sm>
          <div className="grocery_types">
            <Link to="/MainFruitsContent">
              <img
                data-aos="fade"
        ...
        <Col sm>
          <div className="grocery_types">
            <Link to="/MainSnacksContent">
              <img
                data-aos="fade"
                src="https://www.eatthis.com/wp-content/uploads/sites/4/2020/05/snacks-in-america.jpg?quality=82&strip=all&w=1200"
                alt="Snacks"
              ></img>
            </Link>
            <h3>Snacks</h3>
